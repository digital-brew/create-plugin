...
class Register_Blocks {
	...
	/**
	 * Registers all variation scripts.
	 *
	 * @return void
	 */
	public function enqueue_variations_scripts() {
		// Shortcuts for variables.
		$instance        = Plugin::get_instance();
		$slug            = $instance->slug;
		$plugin_dir_path = $instance->plugin_dir_path;
	...
	public function register_blocks() {
		...
		if ( ! file_exists( $script_asset_path ) ) {
			throw new Error(
				'You need to run `npm start` or `npm run build` for the "create-plugin/esnext-example" block first.'
			);
		}
