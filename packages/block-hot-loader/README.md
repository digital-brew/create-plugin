...
Couple the @blockhandbook/block-hot-loader npm package with browsersync and some webpack middleware and you have live reloading for php files and Hot Module Replacement for JS and CSS files.
