						...
						renderContent={ () => {
							return(
									...
									<div className="components-dropdown-menu__menu esnext-example">	
								{
									...
									[
										{ 
											label: __( 'None', 'esnext-example' ), icon: icons.borderRadiusNone, value: 'p-0' 
										},
										{ 
											label: __( 'Small', 'esnext-example' ), icon: icons.borderRadiusSmall, value: 'p-2' 
										},
										{ 
											label: __( 'Medium', 'esnext-example' ), icon: icons.borderRadiusMedium, value: 'p-4' 
										},
										{ 
											label: __( 'Large', 'esnext-example' ), icon: icons.borderRadiusLarge, value: 'p-8' 
										},
										{ 
											label: __( 'X-Large', 'esnext-example' ), icon: icons.borderRadiusXLarge, value: 'p-16' 
										},
									].map( ( item ) => {
										return(
											<MenuItem
